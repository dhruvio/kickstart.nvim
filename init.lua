...
do
  ...
  -- Show line offsets from the cursor, while keeping its absolute line number.
  vim.o.number = true
...
do
  ...
  local parsers = { 'bash', 'c', 'diff', 'elm', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' }
